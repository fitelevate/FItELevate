...
import com.mcadeveloper.fitelevate.databinding.ActivityWaterMainBinding
...
class WaterMainActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityWaterMainBinding
    ...
    private fun setWaterLevel(inTook: Int, totalIntake: Int) {
     ...
     //   val progress = ((inTook / totalIntake.toFloat()) * 100).toInt()
      ...
      //  binding.intakeProgress.indeterminateAnimationType = progress
